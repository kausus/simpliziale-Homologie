...
%	TODO: auf diegleichung mit cref referenzieren
		  	...
		  	Behauptung gezeigt.
% BEMERKUNG: dies zeigt auch die eindeutigkeit der t_i, da lineares gleichungssystem, eindeutige lösung
  	\end{description}
  \end{proof}
...
\begin{Bem}
  ...
  geschrieben werden. Betrachte den Untervektorraum $\E^J \coloneqq \bigoplus\limits_{j \in J} \R$ der
  Elemente die bis auf endlich viele von Null verschieden
  sind. Definiere für zwei Elemente $x,y \in \E^J$ eine Metrik
  \begin{gather*}
